...
import { ShoppingBag, Home, Menu, X, Layers } from 'lucide-react';
...
export default function Header({ activeTab, setActiveTab }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 bg-white border-b border-slate-200 z-40 shadow-sm">
      {/* Official Top Bar */}
      <div className="bg-blue-900 text-white text-xs py-1.5 px-4 font-sans flex items-center justify-between">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500 leading-none font-sans mt-0.5">
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`px-3 py-2 rounded-md text-sm font-semibold transition-colors font-sans cursor-pointer ${
                  isActive
          ...
          <div className="px-2 pt-2 pb-4 space-y-1">
            ...
            <div className="pt-2 px-4">
              <div className="border-t border-slate-200 pt-3">
                <p className="text-sm text-slate-500 font-sans">Hubungi Kantor Kelurahan:</p>
                <p className="text-base font-bold text-slate-800 font-sans mt-0.5">(0341) 322175</p>
              </div>
            </div>
          </div>
        </div>
