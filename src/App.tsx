...
export default function App() {
  ...
  // Automatically scroll to top of the page when navigating between tabs or UMKM details
  useEffect(() => {
    window.scrollTo({ top: 0, behavior: 'auto' });
  }, [activeTab, selectedUmkmId]);
      ...
      <footer className="bg-slate-900 text-slate-400 pt-12 pb-24 md:pb-12 border-t border-slate-800 font-sans">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-12 gap-8 pb-8 border-b border-slate-800">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center space-x-3 text-white">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-slate-400">Kecamatan Sukun • Kota Malang</p>
              </div>
            </div>
          ...
          <div className="md:col-span-4 space-y-4">
            <h3 className="text-sm font-bold uppercase tracking-wider text-white">Kantor Kelurahan</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs sm:text-sm">
